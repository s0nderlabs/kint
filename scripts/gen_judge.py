...
rows = [
 ...
 ("Decision beat goes through Sibyl's search and its typed verdict", "src/kint/verify.py", line("src/kint/verify.py", r"results = client.search\(query"), f"Sibyl `search` at client.py:{line(S+'client.py', r'    def search\(self')} returns `SearchResults` with `.verdict`"),
 ...
 ("Keyed RPC URLs are never printed", "src/kint/chain.py", line("src/kint/chain.py", r"def redact"), ""),
